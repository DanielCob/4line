#lang racket
(provide crearmatriz elementoMatriz algoritmo agregar)
...
(define (heuristica fila columna matriz)
  ...
  (combo (verifHorizontal (agregar 1 columna matriz) fila columna))
  (combo (verifVertical (agregar 1 columna matriz) fila columna))
...
(define (juego matriz columna)
  (display matriz)
  (juego_aux (turno 1 4 columna matriz))
  )

(define (juego_aux matriz)
  (display matriz)
  (juego (turno 2 4 (algoritmo matriz) matriz))
  )
